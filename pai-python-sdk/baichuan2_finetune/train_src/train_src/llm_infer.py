...
from utils import InferArguments, get_dataset, get_model_tokenizer, get_preprocess
...
def merge_lora(args: InferArguments) -> None:
    ...
    merged_lora_path = os.path.abspath(os.path.join(ckpt_dir, f"{ckpt_name}-merged"))
    ...
    if not os.path.exists(args.ckpt_dir):
        ...
        logger.info(
            "The weight directory for the merged LoRa already exists, "
